    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" href="<?= siteUrl();?>/admin/">
              <span data-feather="home"></span>
              Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= siteUrl();?>/admin/product/product.php">
              <span data-feather="file"></span>
              Product
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= siteUrl();?>/admin/product/addproduct.php">
              <span data-feather="file"></span>
              Add Products
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= siteUrl();?>/admin/service/add.php">
              <span data-feather="file"></span>
              Add Services
            </a>
          </li>
